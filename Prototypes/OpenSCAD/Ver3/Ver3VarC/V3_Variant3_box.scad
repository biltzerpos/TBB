/*
        ...
        TITLE --- VERSION 3 - VARIANT 3 - OUTER ROUNDED BOX
...
difference()
{
    ...
    #translate([0, -r_out/4, (1.3)*r_out])lid_v3_att3();
    
}

translate([x_in - x_dist_mount+(x_out-x_in)/4,y_in - y_dist_mount+(y_out-y_in)/4,r_out/2])
{
